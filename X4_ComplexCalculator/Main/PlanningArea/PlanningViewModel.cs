...
using X4_ComplexCalculator.Main.PlanningArea.UI.Menu.View;
...
using X4_ComplexCalculator.Main.PlanningArea.UI.StationSummary;
using X4_ComplexCalculator.Main.PlanningArea.UI.StorageAssign;
using X4_ComplexCalculator.Main.PlanningArea.UI.StoragesGrid;
...
namespace X4_ComplexCalculator.Main.PlanningArea
{
    ...
    /// 作業エリア用ViewModel
    /// </summary>
    class PlanningAreaViewModel : BindableBase, IDisposable
    {
        #region メンバ
        /// <summary>
        /// モデル
        /// </summary>
        private readonly PlanningAreaModel _Model;
        ...
        /// </remarks>
        public PlanningAreaViewModel(long layoutID = -1)
        {
            _LayoutID = layoutID;
            ...
            _Model              = new PlanningAreaModel(moduleModel, productsModel, resourcesModel, storageAssignModel);
