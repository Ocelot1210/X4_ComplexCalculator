...
using X4_ComplexCalculator.Main.PlanningArea.SaveDataReader;
using X4_ComplexCalculator.Main.PlanningArea.SaveDataWriter;
...
namespace X4_ComplexCalculator.Main.PlanningArea
{
    ...
    /// 作業エリア用Model
    /// </summary>
    class PlanningAreaModel : BindableBase, IDisposable, IPlanningArea
    {
        #region メンバ
        /// <summary>
        /// タイトル文字列
        ...
        public PlanningAreaModel(ModulesGridModel modules, ProductsGridModel products, ResourcesGridModel resources, StorageAssignModel storageAssignModel)
        {
            _Modules = modules;
            _Products = products;
