...
/// </summary>
partial class StationCalculatorImport : ObservableObject, IImport
{
    #region メンバ
    /// <summary>
    /// 作業エリア管理
    ...
    public StationCalculatorImport(WorkAreaManager workAreaManager, ILocalizedMessageBox localizedMessageBox)
    {
