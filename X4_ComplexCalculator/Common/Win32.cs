...
public class Win32
{
    ...
    [DllImport("User32.dll", CharSet = CharSet.Unicode, SetLastError = true)]
    internal static extern bool GetWindowRect(IntPtr handle, ref RECT r);
    ...
    internal static string GetDlgItemText(IntPtr hDlg, int nIDDlgItem)
    {
        ...
        var sb = new StringBuilder(len + 1);
        _ = GetWindowText(hItem, sb, sb.Capacity);
        return sb.ToString();
    }
    #endregion
}
