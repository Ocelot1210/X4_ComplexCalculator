...
namespace X4_ComplexCalculator.Common.Behavior
{
    ...
    public static class CloseWindowBehavior
    {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public static bool? GetResult(DependencyObject obj) => (bool?)obj.GetValue(ResultProperty);
        ...
        /// <param name="obj"></param>
        /// <param name="value"></param>
        public static void SetResult(DependencyObject obj, bool? value) => obj.SetValue(ResultProperty, value);
        #endregion
